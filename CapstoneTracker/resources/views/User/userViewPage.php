...
<head>
    ...
    <link rel="icon" href="../../../storage/images/gradcap.png" type="image/x-icon">
    ...
    <link rel="stylesheet" href="../../css/User/userViewPage.css">
...
<body>
    ...
    <div class="searchBar">
        <div class="search-container">
            ...
            <button class="search-icon-btn" type="submit">
                <img class="searchIcon" src="../../../storage/images/search-interface-symbol.png">
            </button>
        </div>
    ...
    <div id="profileContainer" class="content-container">
        <div class="mainProfile">
            <img class="profileIcon" src="../../../storage/images/profile.png">
            <div>
...
<!--
    ...
    <div id="uploadContainer" class="content-container">
        <div>
                ...
                <img src="../../../storage/images/add.png" onclick="dropzoneContainer()" alt="Upload" id="upload-icon" class="upload-icon">
    ...
    <script type="text/javascript" src="../../js/User/userViewPage.js"></script>
</body>
</html>